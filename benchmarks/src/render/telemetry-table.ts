...
const PHASE_COLUMNS: Array<Column<TelemetryRow>> = [
  ...
  {
    header: "Plan catalog ms",
    value: (row) => nested(row, "phaseMs", "planCatalog"),
  },
  {
    header: "Plan directory ms",
    value: (row) => nested(row, "phaseMs", "planDirectory"),
  },
  {
    header: "Plan entries ms",
    value: (row) => nested(row, "phaseMs", "planEntries"),
  },
  {
    header: "Plan validation ms",
    value: (row) => nested(row, "phaseMs", "planValidation"),
  },
