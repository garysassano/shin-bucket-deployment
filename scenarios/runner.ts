...
const VERIFY_SCENARIOS = {
  ...
  "metadata-update-initial": { file: "updates/metadata-update-initial-app.js" },
  "metadata-update-updated": { file: "updates/metadata-update-updated-app.js" },
...
const VERIFY_DEFAULT_GROUPS = [
  ...
  ["metadata-update-initial", "metadata-update-updated"],
