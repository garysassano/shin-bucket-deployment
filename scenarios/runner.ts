...
const VERIFY_SCENARIOS = {
  ...
  "marker-replacement": { file: "content/marker-replacement-app.js" },
  filters: { file: "content/filters-app.js" },
  "source-overwrite-order": { file: "content/source-overwrite-order-app.js" },
  ...
  "object-deletion-initial": { file: "retention/object-deletion-initial-app.js" },
  "object-deletion-updated": { file: "retention/object-deletion-updated-app.js" },
  "object-deletion-bucket-only": {
    file: "retention/object-deletion-bucket-only-app.js",
  },
  "large-archive": { file: "scale/large-archive-app.js" },
  "kms-destination": { file: "security/kms-destination-app.js" },
  "kms-managed-destination": { file: "security/kms-managed-destination-app.js" },
  "dsse-managed-destination": { file: "security/dsse-managed-destination-app.js" },
