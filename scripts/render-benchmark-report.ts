...
function usage(): never {
  console.error(
    "Usage: node dist/scripts/render-benchmark-report.js [--input-file docs/benchmark-history.jsonl] [--output-file docs/benchmark-report.md] [--chart-output-file <path>] [--chart-reference <markdown-path>] [--chart-layout split|scorecard|cards] [--chart-theme signal|forge|circuit] [--run-id <id>] [--series <name>]",
  );
  process.exit(1);
}
