...
const CFN_INTRINSIC_SHAPES = {
  ...
  "Fn::Base64": ANY_VALUE,
  "Fn::Cidr": arrayOf(3, 3, (value, index) =>
    index === 0 ? STRING_VALUE(value) : NUMBER_VALUE(value),
  ),
  "Fn::Contains": arrayOf(2, 2, ANY_VALUE),
  "Fn::EachMemberEquals": arrayOf(2, 2, ANY_VALUE),
  "Fn::EachMemberIn": arrayOf(2, 2, ANY_VALUE),
  "Fn::FindInMap": arrayOf(3, 4, (value, index) =>
    index < 3 ? STRING_VALUE(value) : ANY_VALUE(value),
  ),
  ...
  "Fn::Join": arrayOf(2, 2, (value, index) =>
    index === 0 ? STRING_VALUE(value) : Array.isArray(value),
  ),
  "Fn::Length": oneOf(STRING_VALUE, Array.isArray),
  "Fn::RefAll": STRING_VALUE,
  "Fn::Select": arrayOf(2, 2, (value, index) =>
    index === 0 ? oneOf(STRING_VALUE, NUMBER_VALUE)(value) : Array.isArray(value),
  ),
  "Fn::Split": arrayOf(2, 2, (value, index) =>
    index === 0 ? STRING_VALUE(value) : ANY_VALUE(value),
  ),
  "Fn::Sub": oneOf(
    STRING_VALUE,
    arrayOf(2, 2, (value, index) => (index === 0 ? STRING_VALUE(value) : isPlainRecord(value))),
  ),
